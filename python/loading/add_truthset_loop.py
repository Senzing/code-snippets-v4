...
INPUT_FILES = [
    Path("../../resources/data/truthset/customers.json").resolve(),
    Path("../../resources/data/truthset/reference.json").resolve(),
    Path("../../resources/data/truthset/watchlist.json").resolve(),
]
